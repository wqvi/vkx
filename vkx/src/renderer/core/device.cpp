...
namespace vkx {
    ...
    Device::Device(vk::PhysicalDevice const &physicalDevice, vk::UniqueSurfaceKHR const &surface,
    ...
    vk::Format Device::findSupportedFormat(std::vector<vk::Format> const &candidates, vk::ImageTiling tiling,
    ...
    vk::UniqueImage
    Device::createImageUnique(std::uint32_t width, std::uint32_t height, vk::Format format, vk::ImageTiling tiling,
    ...
    Device::allocateMemoryUnique(vk::UniqueBuffer const &buffer, vk::MemoryPropertyFlags const &flags) const {
    ...
    vk::UniqueDeviceMemory
    Device::allocateMemoryUnique(vk::UniqueImage const &image, vk::MemoryPropertyFlags const &flags) const {
    ...
    vk::UniqueImageView Device::createImageViewUnique(vk::Image const &image, vk::Format format,
    ...
    void Device::submit(std::vector<vk::CommandBuffer> const &commandBuffers, vk::Semaphore const &waitSemaphore,
    ...
    vk::Result Device::present(vk::SwapchainKHR const &swapchain, std::uint32_t imageIndex,
    ...
    bool Device::validatePhysicalDevice(vk::PhysicalDevice const &physicalDevice, vk::UniqueSurfaceKHR const &surface,
                                        Profile const &profile) {
...
void vkx::Device::submit(
    ...
    vk::SubmitInfo submitInfo{
            ...
            waitStage.data(),                                  // pWaitDstStageMask
            static_cast<std::uint32_t>(commands.size()), // commandBufferCount
            commands.data(),                             // pCommandBuffers
            1,                                                 // signalSemaphoreCount
